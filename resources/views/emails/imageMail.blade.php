...
<table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row container-padding" width="640" style="width:640px;max-width:640px;" Simpli>
  ...
  <tr>
    <td class="center-text" align="right">
      <a href="#" Simpli style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:12px;line-height:16px;font-style:normal;font-weight:400;color:#666666;text-decoration:none;letter-spacing:0px;">View this email in your browser</a>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    <td align="center" class="center-text">
      <img style="width:120px;border:0px;display: inline!important;" src="https://assets.selfiestand.hu/assets/images/logo.png" width="120" border="0" editable="true" Simpli data-image-edit  Simpli alt="logo">
    </td>
  </tr>
  <tr>
    <td height="30" style="font-size:30px;line-height:30px;" Simpli>&nbsp;</td>
...
<v:fill type="frame" src="images/header-18.jpg" color="#F4F4F4" />
...
<table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
  <tr>
    <td align="center" background="https://assets.selfiestand.hu/assets/images/email-cover-v2.png" data-bg-image   style="background-size:cover;background-position:center top; border-radius: 36px;">
...
<table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="600" style="width:600px;max-width:600px;">
  <tr>
    <td height="640" valign="bottom" class="container-padding" style="font-size:640px;line-height:640px;" Simpli>
  ...
  <tr>
    <td align="center" Simpli bgcolor="#FFFFFF"  style="border-radius:0 0 36px 36px; border-bottom:solid 6px #DDDDDD;">
      ...
      <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row container-padding" width="520" style="width:520px;max-width:520px;">
        <tr>
          <td class="center-text" Simpli align="center" style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:12px;line-height:24px;font-weight:900;font-style:normal;color:#7b6b9e;text-decoration:none;letter-spacing:2px;">
              <singleline>
                <div mc:edit Simpli>
                  Fényképed érkezett a SelfieStand-től!
                </div>
              </singleline>
          </td>
        </tr>
        <tr>
          <td class="center-text" Simpli align="center" style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:48px;line-height:54px;font-weight:700;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;">
              <singleline>
                <div mc:edit Simpli>
                  Köszönjük, hogy velünk mulattál!
                </div>
              </singleline>
          </td>
        </tr>
        ...
        <tr>
          <td class="center-text" Simpli align="center" style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:16px;line-height:26px;font-weight:300;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;">
              <singleline>
                <div mc:edit Simpli>
                  Megtiszteltetés, hogy minket választottatok, csatolva küldjük a rólatok készült fényképet!
                </div>
              </singleline>
          </td>
        </tr>
        <tr>
          <td height="30"  style="border-bottom: 4px dotted #E4E4E4;font-size:30px;line-height:30px;">&nbsp;</td>
        </tr>
        <tr>
          <td height="30" style="font-size:30px;line-height:30px;" Simpli>&nbsp;</td>
        </tr>
        ...
        <tr>
          <td height="26" style="font-size:26px;line-height:26px;" Simpli>&nbsp;</td>
        </tr>
        <tr>
          <td height="30"  style="border-top: 4px dotted #E4E4E4;font-size:30px;line-height:30px;">&nbsp;</td>
        </tr>
        <tr>
          <td align="center">
            <!-- Paragraphs -->
            <table border="0" cellspacing="0" cellpadding="0" role="presentation" align="center" class="row" width="500" style="width:500px;max-width:500px;">
              <tr>
                <td class="center-text" Simpli align="center" style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:16px;line-height:26px;font-weight:400;font-style:italic;color:#6e6e6e;text-decoration:none;letter-spacing:0px;">
                    <singleline>
                      <div mc:edit Simpli>
                        (Ha bármi kérdésed lenne csak <a href="mailto:info@selfiestand.hu" style="color:#7b6b9e;text-decoration: underline;">válaszolj erre az emailre</a>)
                      </div>
                    </singleline>
                </td>
              </tr>
        ...
        <tr>
                <td class="center-text" Simpli align="center" style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:16px;line-height:26px;font-weight:400;font-style:italic;color:#6e6e6e;text-decoration:none;letter-spacing:0px;">
                    <singleline>
                      <div mc:edit Simpli>
                        Ha te is kibérelnéd a SelfieStand-et
                      </div>
                    </singleline>
                </td>
              </tr>
        <tr>
          <td align="center">
            ...
            <table border="0" cellspacing="0" cellpadding="0" role="presentation" align="center" class="center-float">
              <tr>
                <td align="center"  Simpli bgcolor="#7b6b9e" style="border-radius: 6px;">
            <!--[if (gte mso 9)|(IE)]>
              <table border="0" cellpadding="0" cellspacing="0" align="center">
                <tr>
                  ...
                  <![endif]-->
                    ...
                    <singleline>
                      <a href="https://selfiestand.hu" download rel="noopener noreferrer" target="_blank" mc:edit  style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:16px;line-height:20px;font-weight:700;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;padding: 15px 35px 15px 35px;display: inline-block;"><span>KATTINTS IDE</span></a>
                    </singleline>
                  <!--[if (gte mso 9)|(IE)]>
                  </td>
                  <td align="center" width="35"></td>
...
<table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row container-padding" width="520" style="width:520px;max-width:520px;">
  ...
  <tr>
    <td class="center-text" Simpli align="center" style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:24px;line-height:32px;font-weight:400;font-style:normal;color:#999999;text-decoration:none;letter-spacing:0px;">
        <singleline>
          <div mc:edit Simpli>
           Küldj nekünk üzenetet <strong>#selfiestand</strong>
          </div>
        </singleline>
    </td>
  </tr>
                ...
                <td  class="rwd-on-mobile" align="center" valign="middle" height="36" style="height: 36px;">
                  <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                    <tr>
                      <td width="10"></td>
                      <td align="center">
                      <a href="https://www.facebook.com/selfiestandhu" Simpli style=""><img style="width:36px;border:0px;display: inline!important;" src="https://assets.selfiestand.hu/assets/images/social/Facebook.png" width="36" border="0" editable="true" Simpli data-image-edit  Simpli alt="icon"></a>
                      </td>
                      <td width="10"></td>
                    </tr>
                  </table>
                ...
                <td  class="rwd-on-mobile" align="center" valign="middle" height="36" style="height: 36px;">
                  <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                    <tr>
                      <td width="10"></td>
                      <td align="center">
                      <a href="https://instagram.com/selfiestandhu" Simpli style=""><img style="width:36px;border:0px;display: inline!important;" src="https://assets.selfiestand.hu/assets/images/social/Instagram.png" width="36" border="0" editable="true" Simpli data-image-edit  Simpli alt="icon"></a>
                      </td>
                      <td width="10"></td>
                    </tr>
                  </table>
      ...
      <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="480" style="width:480px;max-width:480px;">
        <tr>
          <td class="center-text" Simpli align="center" style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:480;font-style:normal;color:#666666;text-decoration:none;letter-spacing:0px;">
            <multiline>
              <div mc:edit Simpli>
                Ezt az emailt azért kaptad, mert elküldted magadnak az elkészült fotódat a SelfieStand gépéről!
              </div>
            </multiline>
          </td>
        </tr>
